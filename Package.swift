...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/codedaptive/moot-semantics.git", exact: "1.0.31-rc.1"),
        .package(url: "https://github.com/codedaptive/moot-system.git", exact: "1.0.31-rc.1"),
